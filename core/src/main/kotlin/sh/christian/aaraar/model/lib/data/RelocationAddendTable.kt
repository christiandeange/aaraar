...
data class RelocationAddendTable(
  val values: List<RelocationAddendValue>,
) : NativeSectionData {
  override fun bytes(
    lib: NativeLibrary,
  ...
  companion object {
    fun from(
      ...
      return RelocationAddendTable(values = relocations)
    }
  }
}
